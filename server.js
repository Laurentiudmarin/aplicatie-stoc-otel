// --- server.js - COD COMPLET FINAL (cu corecție pentru trimiterea formularelor) ---
...
// ... (API-urile de admin și migrare rămân neschimbate) ...
...
// --- RUTELE PRINCIPALE (MODIFICATE) ---
const handleUploads = upload.fields([
    { name: 'stoc', maxCount: 1 }
]);

app.post('/process', handleUploads, async (req, res) => {
    const stocFile = req.files.stoc[0]; // Fișierul este acum în req.files.stoc
    try {
